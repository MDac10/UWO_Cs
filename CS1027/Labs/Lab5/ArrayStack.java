...
public class ArrayStack<T> implements StackADT<T> {
	 ...
	 */
	public ArrayStack() {
		top = 1; //Specific type of stack top/start
	...
	public String toString() {
		String stackString =  "";
		if(isEmpty()) {
			stackString = "The stack is empty.";
		} else {stackString = "Stack: ";}
		for(int index = top-1; index > 1; index--) {
			stackString = stackString + stack[index] + ", ";
			if(index == 2) {
				stackString = stackString + stack[1] + ".";
			}
		}
		return stackString;
	}
